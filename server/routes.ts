...
import sellersRoute from "../routes/admin/sellers.js";
import sellersMe from "../routes/sellers/me.js";
import sellersApply from "../routes/sellers/apply.js";
import sellersProducts from "../routes/sellers/products.js";
...
export function registerRoutes(app: express.Express) {
  ...
  // Admin routes
  app.use("/api/admin/sellers", sellersRoute);

  // Seller routes
  app.use("/api/sellers/me", sellersMe);
  app.use("/api/sellers/apply", sellersApply);
  app.use("/api/sellers/products", sellersProducts);
